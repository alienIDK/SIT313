...
/***
 * 
 * Smallheader.jsx file
 import React from 'react';

function Smallheader(){
    return (<h1 className='header'>Zoo Life </h1>)
...
function Image(){
    return(
      <div>
        <img src = {require('./images/1.png')} alt = "human1" width = {300} height = {300}></img>
        <img src = {require('./images/2.png')} alt = "human2" width = {300} height = {300}></img>
        <img src = {require('./images/3.png')} alt = "human3" width = {300} height = {300}></img>
      </div>
